-- ============================================================
-- Migración 023: Prohibir acción invented "present_templates"
--
-- El modelo inventa la acción "present_templates" porque el prompt
-- no dice explícitamente que mostrar la lista se hace con "finish".
-- Se añade la regla explícita y un ejemplo JSON de presentación.
--
...
SELECT
    ...
    'Backup antes de 023: prohibir present_templates, usar finish para lista',
    'migracion_023'
...
ELSE
    PRINT 'OK: Prompt del agente alertas actualizado (023).';
GO
