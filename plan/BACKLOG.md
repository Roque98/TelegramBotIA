...
## 🟠 Alta — Arquitectura y Estabilidad (5)

| # | Plan | Archivo clave | Estado |
|---|------|---------------|--------|
| 5 | [Consolidar async/sync](02-activos/PLAN_ARQ_05_ASYNC_SYNC.md) | `memory/`, `knowledge/`, `agents/tools/` | Pendiente |
| 6 | [Cache con evicción](02-activos/PLAN_ARQ_06_CACHE_EVICCION.md) | `memory/memory_service.py` | Pendiente |
