        ...
        if tickets_result.success and tickets_result.data:
            ...
            messages = [
                {"role": "system", "content": (
                    ...
                    "El resultado DEBE estar en formato Markdown: usa emojis como íconos de sección, "
                    "viñetas (•) para listas, y bloques de código (```) exclusivamente para comandos de terminal. "
                    "No uses asteriscos (*) para negrita.\n\n"
                    ...
                    f"1. [acción concreta basada en acciones correctivas históricas; usa ``` para comandos] (ref: ticket #ID)\n"
                    f"2. [acción] (ref: ticket #ID)\n"
                    f"(máximo 5 acciones)\n\n"
                    f"{DIV}\n"
                    f"📋 PATRÓN DETECTADO\n"
