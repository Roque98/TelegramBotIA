...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    help_message = (
        "*📖 IRIS \\- Agente de Monitoreo PRTG*\n\n"
        "Soy tu asistente para gestión de alertas e incidentes\\. "
        "Consulto en tiempo real el sistema de monitoreo y te doy la información que necesitas\\.\n\n"
        "*🔍 ¿Qué puedo hacer?*\n\n"
        "*Alertas activas*\n"
        "Consulta el estado actual del monitoreo PRTG para Banco y EKT\\.\n"
        "   • _¿Hay alertas activas ahora mismo?_\n"
        "   • _¿Qué equipos están caídos?_\n"
        "   • _Muéstrame las alertas de CPU_\n\n"
        "*Detalle de un equipo*\n"
        "Análisis completo de un nodo: sensor, área responsable y acciones sugeridas\\.\n"
        "   • _Dame el detalle de la IP 10\\.80\\.133\\.47_\n"
        "   • _¿Qué área atiende ese equipo?_\n\n"
        "*Historial de tickets*\n"
        "Incidentes pasados de un equipo y las acciones correctivas aplicadas\\.\n"
        "   • _¿Qué tickets tuvo la IP 10\\.50\\.107\\.229?_\n"
        "   • _¿Cuántas veces ha fallado ese servidor?_\n\n"
        "*Escalamiento y contactos*\n"
        "Matriz de escalamiento y datos de contacto del área responsable\\.\n"
        "   • _¿A quién escalo esta alerta?_\n"
        "   • _Dame el contacto del área que atiende esa IP_\n\n"
        "*Inventario*\n"
        "Datos técnicos del equipo: tipo, área atendedora y administradora\\.\n"
        "   • _¿Qué equipo es la IP 10\\.82\\.47\\.195?_\n\n"
        "*Comandos:*\n"
        "/start \\- Bienvenida\n"
        "/help \\- Esta guía\n"
    ...
    keyboard = InlineKeyboardMarkup([[
        InlineKeyboardButton(
            ...
            web_app=WebAppInfo(url="https://telegram-bot-q7gm9uwke-roque98s-projects.vercel.app/help-miniapp.html")
        )
    ]])
