...
class PermissionChecker:
    ...
    def check_permission(
        ...
        try:
            query = text("""
                EXEC consolamonitoreo..IABOT_sp_VerificarPermisoOperacion
                    @idUsuario = :user_id,
                    @comando = :comando
            """)
    ...
    def get_user_operations(self, user_id: int) -> List[Operation]:
        ...
        try:
            query = text("""
                EXEC consolamonitoreo..IABOT_sp_ObtenerOperacionesUsuario
                    @idUsuario = :user_id
            """)
    ...
    def log_operation(
        ...
        try:
            ...
            query = text("""
                EXEC consolamonitoreo..IABOT_sp_RegistrarLogOperacion
                    @idUsuario = :user_id,
                    @comando = :comando,
